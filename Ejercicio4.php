...
class Transporte {
    ...
    public function getInfo() : string {
        return "El trasnporte tiene" .$this ->ruedas ."ruedas y una capacidad de" .$this->capacidad ."personas";  
    }
...
class Bicicleta extends Transporte {
    public function getInfo() : string {
    return "El trasnporte tiene" .$this->ruedas ."ruedas y una capacidad de" .$this->capacidad ."personas y no gasta gasolina";
    }
}
